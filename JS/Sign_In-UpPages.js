...
function createNewUser(newUser) {
    ...
    if (resultUserName && resultUserEmail && resultInputRulse) {
        ...
        if(!resultUserName)
            alert('⚠️ VALIDATION ERROR: Username is already exists is already registered. Please log in or use a different email address or username.');
        if(!resultUserEmail)
            alert('⚠️ VALIDATION ERROR: Email is already exists address is already registered. Please log in or use a different email address or username.');
    }
